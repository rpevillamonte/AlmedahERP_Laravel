...
$("#msg-filter").find(".dropdown-submenu > ul > li > a").click(function () {
    // Function for user choose to filter the messages through the groups or roles.
    $("#msg-group").html($(this).html());
    
});
$("#empty-compose-val").click(function(){
    $("#msg-compose-group").html($(this).html());
    $("#msg-compose-group").attr("val", "0");
    $("#row-to").slideUp();
});
$("#messageModal").find(".dropdown-submenu > ul > li > a").click(function () {
    // Function for user to choose for the recipients' group or role.
    $("#msg-compose-group").html($(this).html());
    $("#msg-compose-group").attr("val", "1");
    if ($("#msg-compose-group").attr("val") !== "0") {
        $("#row-to").slideDown();
    }
});
...
$(".inbox-dropdown").on("hidden.bs.dropdown", function(){
    $(this).find(".dropdown-submenu>ul.dropdown-menu").removeClass("show");
});

$(".star-icon").on("click",function(){
    $(this).find(".fa-star").css("display","block");
    $(this).find(".fa-star").removeClass("far").addClass("fas");
    $(this).find(".fa-star").css("color","#bdb700");
});
