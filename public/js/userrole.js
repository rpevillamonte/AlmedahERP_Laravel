    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (let key in permissions) {
                ...
                tr.find(".edit-user-view").prop(
                    "checked",
                    getCheckStatus(role_prop.view)
                );
                tr.find(".edit-user-create").prop(
                    "checked",
                    getCheckStatus(role_prop.create)
                );
                tr.find(".edit-user-edit").prop(
                    "checked",
                    getCheckStatus(role_prop.edit)
                );
                tr.find(".edit-user-delete").prop(
                    "checked",
                    getCheckStatus(role_prop.delete)
                );
            }
        },
    });
