                ...
                <form id="update-material-form" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                          ...
                          <input type="text" value="0" id="edit_reorder_level" name="reorder_level" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>

                        <div class="form-group col-6">
                          <label for="">Reorder Quantity</label>
                          <input type="text" value="0" id="edit_reorder_quantity" name="reorder_quantity" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
