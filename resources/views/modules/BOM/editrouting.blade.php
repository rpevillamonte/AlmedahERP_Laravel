  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="responsive">
      ...
      <li class="nav-item dropdown li-bom">
        ...
        <li class="nav-item li-bom">
            <form action="{{ route('routing.destroy', ['routing' => $route->id]) }}" id="deleteRouting" method="post">
                @csrf
                @method('DELETE')
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" name="Routing_Name" id="Routing_Name" value="{{ $route->routing_name }}" class="form-control">
                </div>
            </div>
        </div>
        ...
        <table class="table border-bottom table-hover table-bordered" id="operations">
            ...
            <tbody class="" id="newrouting-input-rows">
                ...
                <tr data-id="<?=$i?>">
                    ...
                    <td id="mr-code-input" class="mr-code-input"><input type="number" value="{{ $ro['sequence_id'] }}" name="seq_id" id="seq_id<?=$i?>"
                            class="form-control" readonly></td>
                    <td class="mr-qty-input"><input type="text" value="{{ $ro['operation_id'] }}" name="operation"
                            id="operation<?=$i?>" class="form-control operation" list="operations_list" onchange="operationSearch(<?=$i?>);">
                    </td>
                    <td class="mr-unit-input"><input type="text" value="{{ $ro['operation']->wc_code }}" name="workcenter" id="workcenter<?=$i?>"
                            class="form-control" disabled>
                    </td>
                    </td>
                    <td class="mr-unit-input"><input type="text" value="{{ $ro['operation']->description }}" name="description" id="description<?=$i?>"
                            class="form-control" disabled></td>
                    <td class="mr-unit-input"><input type="number" value="{{ $ro['hour_rate'] }}" name="hour_rate" id="hour_rate<?=$i?>"
                            class="form-control"></td>
                    <td class="mr-unit-input"><input type="text" value="{{ $ro['operation_time'] }}" name="operation_time" id="operation_time<?=$i?>"
                            class="form-control"></td>
                    <td>
